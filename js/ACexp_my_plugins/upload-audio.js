...
jsPsych.plugins["upload-audio"] = (function() {
...
//////////////////////////////// ON FINISH /////////////////////////////////////
      ...
      // maybe should check that i < count()
      // console.log("Stimulus index: " + i);
      ...
      var file_ID = part_ID + "_" + DATE + "_" + trialNdx.toString().padStart(4, '0') + "_" + stim.replace(/ /g, "");

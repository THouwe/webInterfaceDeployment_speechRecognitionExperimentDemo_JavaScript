...
jsPsych.plugins["audio-upload-audio"] = (function() {

    let plugin = {};

    plugin.info = {
        name: 'audio-upload-audio',
...
//////////////////////////////// ON FINISH /////////////////////////////////////
      ...
      function sendTheWav(blob) {
        ...
        var file_ID = part_ID + "_" + DATE + "_" + trialNdx.toString().padStart(4, '0') + "_" + stim_name.replace(/ /g, "");

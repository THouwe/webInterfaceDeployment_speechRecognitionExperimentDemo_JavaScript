...
jsPsych.plugins["audio-upload-audio-practice"] = (function() {

    let plugin = {};

    plugin.info = {
        name: 'audio-upload-audio-practice',
...
//////////////////////////////// PLAY AUDIO ////////////////////////////////////
        ...
        //   source.buffer = jsPsych.pluginAPI.getAudioBuffer(trial.audio_out);
        //   source.connect(context.destination);
        // } else {
        //   console.log(trial.audio_out)
        //   console.log(jsPsych.pluginAPI.getAudioBuffer)
        //   var audio = jsPsych.pluginAPI.getAudioBuffer(trial.audio_out);
        //   audio.currentTime = 0;
        // }
        ...
        //
        var audio = new Audio(trial.audio_out);
        audio.play();
...
//////////////////////////////// ON FINISH /////////////////////////////////////
      ...
      function sendTheWav(blob) {
        ...
        // look for latest stimulus
        var i;
        for (i = jsPsych.data.get().count() - 1; i >= 0; i--) {
          if ("stimulus" in jsPsych.data.get().values()[i]) break;
        }
        ...
        var part_ID = jsPsych.data.get().values()[i].part_ID;
        var stim = jsPsych.data.get().values()[i].stimulus;
        // stim = stim.split(/[\\\/]/).pop();
        console.log(stim)
        // var str_start = 29;
        // var str_end = stim.length - 8;
        // console.log(stim.substring(29, str_end));
        // var stim_name = stim.substring(str_start, str_end);
        var stim_name = stim.substring(29, stim.length - 8);
        stim_name = stim_name.split(/[\\\/]/).pop();
        console.log("stim name = " + stim_name)
        console.log("stim name without spaces = " + stim_name.replace(/ /g, ""))

        // console.log("last stimulus: " + stim);
        var trialNdx = jsPsych.data.get().values()[i].trial_index;
        ...
        var file_ID = part_ID + "_" + DATE + "_" + trialNdx.toString().padStart(4, '0') + "_" + stim_name.replace(/ /g, "") + "_practice";
        console.log("file_ID: " + file_ID);

        var fileID = new Blob([file_ID], {type: "text/plain"})

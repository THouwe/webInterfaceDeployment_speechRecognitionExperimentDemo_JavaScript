/**
 * jspsych-audio-button-response-simple
 *
 **/

jsPsych.plugins["audio-button-response-simple"] = (function() {
	var plugin = {};

	jsPsych.pluginAPI.registerPreload('audio-button-response-simple', 'stimulus', 'audio');
